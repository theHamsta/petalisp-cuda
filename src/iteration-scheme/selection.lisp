...
(defun select-iteration-scheme (kernel block-shape-as-list array-strides)
  (let* ((iteration-strides (loop for range in (shape-ranges (kernel-iteration-space kernel))
